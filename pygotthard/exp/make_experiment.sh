...
#for num_clients in $(seq 1 2 40)
#for num_clients in $(seq 264 8 336)
...
do
    ...
    #for write_ratio in $(seq 0 0.05 1)
    for write_ratio in 0.2
    #for write_ratio in $(seq 0 0.1 1)
    do
        for duration in 300
        do
            ...
            #echo "sudo ip netns exec ns_eth0 /home/theo/src/gotthard/cgotthard/client -c $num_clients -d $duration -w $write_ratio -s out/gotthard_results.json 192.168.1.13 1234" >> $exp_dir/run.sh
            #echo "sleep 5" >> $exp_dir/run.sh
            #echo "sudo ip netns exec ns_eth0 /home/theo/src/gotthard/cgotthard/client -c $num_clients -d $duration -w $write_ratio -s out/baseline_results.json 192.168.1.13 1235" >> $exp_dir/run.sh
